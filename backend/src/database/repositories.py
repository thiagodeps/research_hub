...
class BaseRepository:
    ...
    def get_all(self, limit: int = 100, offset: int = 0, search: str = None, sort: str = None, order: str = "asc"):
        db = get_db()
        return db.get_all(self.table_name, limit, offset, search=search, sort=sort, order=order)
